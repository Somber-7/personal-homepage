  ...
  await prisma.project.createMany({
    data: [
      ...
      },
      {
        ...
        org: "쓰리애니아이앤시",
        period: "",
        desc: "대기업 계열 공익재단인 KT그룹희망나눔재단의 사이트입니다. 재단·사업 소개, 후원 및 기부 신청 폼, 후원 현황 조회, 공지·사업보고·나눔스토리 게시판, 사업 실적 통계 표시를 갖췄고, 백엔드를 전담해 구축하고 유지보수했습니다.",
        role: "백엔드 전담 · 유지보수",
        tags: J(["PHP"]),
        order: 11,
      },
      {
        ...
        org: "쓰리애니아이앤시",
        period: "",
        desc: "글로벌 하이파이 오디오 브랜드 Astell&Kern의 한·영·중·일 4개 국어 브랜드 사이트입니다. 제품 라인별 카탈로그와 상세, 리뷰·전시·갤러리, FAQ·다운로드, 판매처 찾기를 갖췄고, 백엔드를 전담해 구축하고 유지보수했습니다.",
        role: "백엔드 전담 · 유지보수",
        tags: J(["PHP", "AWS"]),
        order: 12,
      },
      {
        ...
        org: "쓰리애니아이앤시",
        period: "",
        desc: "대기업 B2B 제조사 현대웰딩의 제품 카탈로그 사이트입니다. 7개 용접공정 × 재질별 다단계 분류, 카테고리 필터와 페이지네이션, 제품별 용접 규격(AWS/ISO)과 자료 제공, 한·영 2개 국어를 갖췄고, 백엔드를 전담해 구축하고 유지보수했습니다.",
        role: "백엔드 전담 · 유지보수",
        tags: J(["PHP"]),
        order: 13,
      },
      {
        ...
        org: "쓰리애니아이앤시",
        period: "",
        desc: "자동차 품질 교육기관(VDA QMC 파트너) GQA의 사이트입니다. 공개·기업체 맞춤 교육 신청 시스템, 교육일정 캘린더, 회원 포털(수강 이력·수료증 발급), 도서 판매, 공지·FAQ·Q&A·불편신고를 갖췄고, 백엔드를 전담해 구축하고 유지보수했습니다.",
        role: "백엔드 전담 · 유지보수",
        tags: J(["PHP"]),
        order: 14,
      },
