  ...
  await prisma.project.createMany({
    data: [
      ...
      },
      {
        ...
        result: "유가가 신차 등록에 반영되기까지 평균 3개월 리드타임 확인\n친환경차 수요는 유가보다 보조금·인프라 같은 정책 요인에 좌우된다는 점을 데이터로 검증",
