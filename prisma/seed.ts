  ...
  await prisma.project.createMany({
    data: [
      ...
      },
      {
        ...
        client: "SK네트웍스 Family AI 캠프 최종 프로젝트 halil · 임베딩 인프라",
        org: "SK네트웍스 Family AI 캠프",
        period: "2026.08",
        desc: "최종 프로젝트 halil의 문서 파싱·임베딩을 맡는 RunPod Serverless GPU 워커입니다. 워커 저장소와 파싱 보완 레이어(읽기 순서 교정, 제목 보정, 표 판별, 이미지 설명)는 팀원이 만들었고, 저는 이를 halil 서비스에 맞게 옮겨 배포했습니다. 그 과정에서 PDF OCR 의존성을 정리하고, 텍스트 레이어가 있는 PDF는 OCR을 건너뛰게 했으며, 표 한 줄이 넘쳐도 문서 전체를 버리지 않도록 고쳤습니다. txt·md 입력을 지원하면서 워커 지원 형식과 업로드 허용 형식이 어긋나지 않도록 동기화 테스트를 추가했고, Python 3.10 호환성도 보완했습니다.",
        role: "배포·통합 · OCR·입력 형식 보완",
