  ...
  await prisma.experience.createMany({
    data: [
      ...
      },
      {
        ...
        tags: J(["Java", "PHP", "eGovFramework", "Oracle", "Altibase", "WebLogic", "Linux"]),
        isCurrent: false,
        order: 3,
      },
    ],
  ...
  await prisma.project.createMany({
    data: [
      ...
      },
      {
        ...
        tags: J(["PHP", "jQuery", "WebLogic", "Linux"]),
        order: 9,
      },
      {
      ...
      },
      {
        ...
        work: "PM · 일정 조율\nGit 브랜치 · 서버 인프라 관리\n평가: RAG+Tool과 파인튜닝 비교 평가 보고서 작성",
        solution: "구조: LangGraph ReAct Router → RAG · 계산 · 법령 API · 그래프 4경로 분기\n도구: FastMCP 도구 16개",
        result: "예비 비교 (11개 케이스, gpt-5.4 채점 5점 척도, 사람 검수 없음): RAG+Tool 4.09점 vs QLoRA 파인튜닝 1.63점\n4차 프로젝트에 RAG+Tool 구조 채택",
      ...
      },
      {
        ...
        tags: J(["Python", "scikit-learn", "LightGBM", "XGBoost", "PyTorch", "Streamlit", "MySQL"]),
        order: 2,
      },
      {
