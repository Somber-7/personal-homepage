  ...
  await prisma.project.createMany({
    data: [
      ...
      },
      {
        ...
        org: "쓰리애니아이앤시",
        period: "",
        desc: "후원 신청 기능이 들어간 KT그룹희망나눔재단 사이트의 백엔드를 전담하고 유지보수했습니다.",
        role: "백엔드 전담 · 유지보수",
        tags: J(["PHP"]),
        order: 11,
      },
      {
        ...
        org: "쓰리애니아이앤시",
        period: "",
        desc: "4개 국어로 운영하는 Astell&Kern 브랜드·제품 사이트의 백엔드를 전담하고 유지보수했습니다.",
        role: "백엔드 전담 · 유지보수",
        tags: J(["PHP", "AWS"]),
        order: 12,
      },
      {
        ...
        org: "쓰리애니아이앤시",
        period: "",
        desc: "다단계 제품 분류와 필터가 들어간 현대웰딩 B2B 제품 카탈로그 사이트의 백엔드를 전담하고 유지보수했습니다.",
        role: "백엔드 전담 · 유지보수",
        tags: J(["PHP"]),
        order: 13,
      },
      {
        ...
        org: "쓰리애니아이앤시",
        period: "",
        desc: "교육 신청과 회원 수료증 시스템이 들어간 GQA 사이트의 백엔드를 전담하고 유지보수했습니다.",
        role: "백엔드 전담 · 유지보수",
        tags: J(["PHP"]),
        order: 14,
      },
